...
function cadastrarEmpresa(req, res) {
    ...
    if (nome == undefined) {
        ...
        funcionarioModel.cadastrarEmpresa(nome, cargo, email, senha, telefone, cpf, dataNascimento, razao, cnpj, cep, logradouro, numero, complemento, nomeBairro)
            .then(
                function (resultado) {
                    res.json(resultado);
                }
...
function cadastrarFuncionario(req, res) {
    ...
    if (nome == undefined) {
        ...
        res.status(400).send("Seu fkSupervisor está undefined!");
        ...
        // Passe os valores como parâmetro e vá para o arquivo funcionarioModel.js
        funcionarioModel.cadastrarFuncionario(nome, cargo, email, senha, telefone, cpf, dataNascimento, fkSupervisor, idFilial)
            .then(
                function (resultado) {
                    res.json(resultado);
                }
...
function buscarFiliais(req, res) {
    var fkFiliais = req.params.fkFiliais;

    funcionarioModel.buscarFiliais(fkFiliais)
        .then(function (resultado) {
            if (resultado.length > 0) {
                res.status(200).json(resultado);
            } else {
